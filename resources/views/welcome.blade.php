...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top"  style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand"><b>STIKES Intan Martapura</b></a>
  ...
  <!-- Full Width Column -->
  <div class="content-wrapper"  style="background-image: url('/logo/b.jpeg'); background-size:cover">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="text-center">
              <img src="/logo/logo.jpeg" width="25%"><br/><br/>
            </div>
            <div class="box box-primary" style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);">
              ...
              <div class="box-footer social-auth-links">
                ...
                <a href="/daftar" class="btn btn-block bg-purple btn-flat"><i class="fa fa-users"></i> Registrasi Mahasiswa Baru</a>
              </div>
              </form>
            </div>
          </div>
